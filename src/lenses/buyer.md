  ...
  <div class="chart-wrap">
    <div class="chart-header">
      <div class="obs-label" style="margin-bottom:0">
        ${langVal === "pt" ? "Atividade por Dia da Semana — WTB" : "Activity by Weekday — WTB"}
      </div>
      ${wdData.length ? html`<span class="cov-badge" style="background:rgba(106,159,207,0.15);color:#6a9fcf">${
        (() => { const peak = wdData.reduce((a,b)=>a.count>b.count?a:b,wdData[0]); return peak.day; })()
      } ★</span>` : ""}
    </div>
    ${WeekdayChartSingle(wdData, "WTB", { lang: langVal, width: 680 })}
  </div>
</div>
</div>`);
```
...
<div class="obs-section">
  <div class="obs-label">${langVal === "pt" ? "Itens mais buscados" : "Most sought items"}</div>
...
<div class="obs-grid-2" style="margin-top:1.5rem;gap:1rem">
  <div class="chart-wrap">
    ${TokenBar(tk.enchants, {
      title: langVal === "pt" ? "Enchants buscados" : "Enchants sought",
      lang: langVal, maxItems: 12, color: "#6a9fcf"
    })}
  </div>
  <div class="chart-wrap">
