...
// Bloco 0: Carregamento de Dados (Raiz de dependência)
...
// Bloco 1: Preparação dos Arrays (Isolamento de lógica)
...
const maxCount = data.top_sellers[0] ? data.top_sellers[0].count : 0;
```
...
<div class="obs-page">
  ...
  <div class="method-note" style="margin-bottom:1.5rem">
    ...
    This lens counts seller <em>mentions</em> in the trade channel corpus.
