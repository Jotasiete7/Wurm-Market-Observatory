...
<div class="obs-page">
  ...
  <div class="obs-section">
    <h2>${lang.value === "pt" ? "Os dois projetos" : "The two projects"}</h2>
    <p>
      ${lang.value === "pt"
  ...
  <div class="obs-section">
    <h2>${lang.value === "pt" ? "O que são lentes?" : "What are lenses?"}</h2>
    <p>
      ${lang.value === "pt"
  ...
  <div class="obs-section">
    <h2>${lang.value === "pt" ? "Cobertura e lacunas (gaps)" : "Coverage and gaps"}</h2>
    <p>
      ${lang.value === "pt"
