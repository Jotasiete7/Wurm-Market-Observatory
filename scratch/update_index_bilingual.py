...
<div class="obs-section">
<div class="obs-label">Cronologia Reconstruída — todos os corpora</div>
${CoverageTimeline(meta.all_corpora)}
</div>

<div class="obs-section">
<div class="obs-label">Observações recentes</div>
...
<div class="obs-meta">seller_activity · ${corpus.period} · ${Math.round(seller.coverage * 100)}% cov</div>
</div>
</div>
<div class="obs-item">
<div class="obs-dot"></div>
...
<div class="obs-section">
<div class="obs-label">Lentes Disponíveis</div>
